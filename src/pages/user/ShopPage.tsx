...
const ShopPage: React.FC = () => {
  ...
  const fetchProducts = useCallback(async (search: string = '') => {
    try {
      ...
      // Add size filter (use first selected size)
  ...
  }, [selectedCategory, minPrice, maxPrice, selectedSizes, selectedColors, sortBy, availabilityFilter]);
  ...
  return (
    <div className="container mx-auto px-4 py-4 sm:py-6 md:py-8">
      ...
      <div className="mb-4 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Shop All Products</h1>
      ...
      <div className="md:hidden mb-4">
        <button
          ...
          className="w-full px-4 py-3 bg-primary text-white rounded-lg flex items-center justify-between font-medium text-sm sm:text-base shadow-md hover:shadow-lg transition-shadow"
        >
          ...
          <span className="text-lg font-bold">{showFilters ? '−' : '+'}</span>
        </button>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className={`md:w-1/4 ${showFilters ? 'block' : 'hidden md:block'}`}>
          <div className="bg-white rounded-lg shadow-md p-4 sm:p-6 sticky top-4 space-y-4 sm:space-y-6 max-h-[calc(100vh-2rem)] overflow-y-auto">
            {/* Search */}
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3 text-gray-800">Search</h3>
              <input
                type="text"
            ...
            {/* Categories */}
            <div>
              <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3 text-gray-800">Categories</h3>
        ...
        <div className="md:w-3/4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 sm:mb-6 gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <select
                ...
                className="flex-1 sm:flex-none px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
              >
          ...
          {filteredAndSortedProducts.length === 0 ? (
            <div className="text-center py-8 sm:py-12">
              ...
              <button
                onClick={handleClearFilters}
                className="px-4 sm:px-6 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition-colors text-sm sm:text-base"
              >
                Clear Filters
              </button>
            </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-5">
              {filteredAndSortedProducts.map((product) => {
                const productPrice = product.variants.length > 0
                  ...
                  : (product.price || 0);
                const productImage = getImageUrl(product.variants[0]?.images?.[0]) || '/images/placeholder.jpg';
                    ...
                    <div className="p-3 sm:p-4 space-y-2">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0 pt-1">
                        ...
                        <button
                          ...
                          className="w-full sm:w-auto px-3 sm:px-4 py-1.5 sm:py-2 bg-primary text-white text-xs sm:text-sm rounded-lg hover:bg-primary-dark transition-colors"
                        >
                          View Details
                        </button>
                      </div>
